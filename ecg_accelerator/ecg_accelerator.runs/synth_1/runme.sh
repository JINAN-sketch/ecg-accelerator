...
HD_PWD='D:/Project_3/ecg_accelerator/ecg_accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ecg_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ecg_top.tcl
