...
REM
REM Generated by Vivado on Wed May 27 14:26:35 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_squarer_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_squarer_vlog.prj -log xvlog.log
