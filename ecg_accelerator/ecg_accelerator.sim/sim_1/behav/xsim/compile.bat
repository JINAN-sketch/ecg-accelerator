...
REM
REM Generated by Vivado on Wed May 27 15:54:44 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_threshold_fsm_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_threshold_fsm_vlog.prj -log xvlog.log
