...
REM
REM Generated by Vivado on Fri May 29 11:59:12 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_mad_classifier_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_mad_classifier_vlog.prj -log xvlog.log
