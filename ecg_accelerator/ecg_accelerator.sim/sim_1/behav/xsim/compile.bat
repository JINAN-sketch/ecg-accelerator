...
REM
REM Generated by Vivado on Sun May 31 20:32:21 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_ecg_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_ecg_top_vlog.prj -log xvlog.log
