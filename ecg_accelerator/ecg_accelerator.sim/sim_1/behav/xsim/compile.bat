...
REM
REM Generated by Vivado on Wed May 27 15:30:24 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_mwi_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_mwi_vlog.prj -log xvlog.log
