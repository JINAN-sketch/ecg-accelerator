...
module tb_squarer;
    ...
    localparam PIPELINE  = 1;      // single cycle pipeline
    ...
    initial begin
        $readmemh("D:/Project_3/vectors/squarer_input_hex.txt",  in_vec);
        $readmemh("D:/Project_3/vectors/squarer_output_hex.txt", exp_vec);
